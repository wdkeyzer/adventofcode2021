...
```{r}
data <- raw %>% 
  tidyr::separate(col = text, into = c("direction", "units"), sep = " ") 
...
We can remove the directions down and up since we don't need this anymore and the calculation op depth for these rows has no meaning.
